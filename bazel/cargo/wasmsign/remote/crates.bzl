...
# buildifier: disable=bzl-visibility
load("//bazel/cargo/wasmsign/remote:defs.bzl", _crate_repositories = "crate_repositories")
...
def crate_repositories():
    ...
    maybe(
        ...
        name = "ws",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.bazel"),
        defs_module = Label("//bazel/cargo/wasmsign/remote:defs.bzl"),
    )
