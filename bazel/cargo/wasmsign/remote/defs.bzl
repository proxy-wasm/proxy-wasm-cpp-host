...
_NORMAL_DEPENDENCIES = {
    "bazel/cargo/wasmsign": {
        _COMMON_CONDITION: {
            "wasmsign2-cli": Label("@ws//:wasmsign2-cli-0.2.6"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "ws__adler2-2.0.1",
        sha256 = "320119579fcad9c21884f5c4861d16174d0e06250625266f50fe6898340abefa",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/adler2/2.0.1/download"],
        strip_prefix = "adler2-2.0.1",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.adler2-2.0.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__aho-corasick-1.1.4",
        sha256 = "ddd31a130427c27518df266943a5308ed92d4b226cc639f5a8f1002816174301",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/aho-corasick/1.1.4/download"],
        strip_prefix = "aho-corasick-1.1.4",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.aho-corasick-1.1.4.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__anyhow-1.0.100",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.anyhow-1.0.100.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__autocfg-1.5.0",
        sha256 = "c08606f8c3cbf4ce6ec8e28fb0014a2c086708fe954eaa885384a6165172e7e8",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/autocfg/1.5.0/download"],
        strip_prefix = "autocfg-1.5.0",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.autocfg-1.5.0.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__base64-0.22.1",
        sha256 = "72b3254f16251a8381aa12e40e3c4d2f0199f8c6508fbecb9d91f575e0fbb8c6",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/base64/0.22.1/download"],
        strip_prefix = "base64-0.22.1",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.base64-0.22.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__base64-0.9.3",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.base64-0.9.3.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__bitflags-1.3.2",
    ...
    maybe(
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.bitflags-2.10.0.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__bumpalo-3.19.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.bumpalo-3.19.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__byteorder-1.5.0",
        sha256 = "1fd0f2584146f6f2ef48085050886acf353beff7305ebd1ae69500e27c67f64b",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/byteorder/1.5.0/download"],
        strip_prefix = "byteorder-1.5.0",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.byteorder-1.5.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.cc-1.2.50.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__cfg-if-1.0.0",
    ...
    maybe(
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.clap-3.2.25.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__clap_lex-0.2.4",
        sha256 = "2850f2f5a82cbf437dd5af4d49848fbdfc27c157c3d010345776f952765261c5",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/clap_lex/0.2.4/download"],
        strip_prefix = "clap_lex-0.2.4",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.clap_lex-0.2.4.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__crc32fast-1.5.0",
        sha256 = "9481c1c90cbf2ac953f07c8d4a58aa3945c425b7185c9154d67a65e4230da511",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/crc32fast/1.5.0/download"],
        strip_prefix = "crc32fast-1.5.0",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.crc32fast-1.5.0.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__ct-codecs-1.1.6",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.ct-codecs-1.1.6.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__displaydoc-0.2.5",
        sha256 = "97369cbbc041bc366949bc74d34658d6cda5621039731c6310521892a3a20ae0",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/displaydoc/0.2.5/download"],
        strip_prefix = "displaydoc-0.2.5",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.displaydoc-0.2.5.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__ed25519-compact-2.2.0",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.ed25519-compact-2.2.0.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__env_filter-0.1.4",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.env_filter-0.1.4.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__env_logger-0.11.8",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.env_logger-0.11.8.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__errno-0.3.14",
        sha256 = "39cab71617ae0d63f51a36d69f866391735b51691dbda63cf6f96d042b63efeb",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/errno/0.3.14/download"],
        strip_prefix = "errno-0.3.14",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.errno-0.3.14.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__find-msvc-tools-0.1.5",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.find-msvc-tools-0.1.5.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__flate2-1.1.5",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.flate2-1.1.5.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__form_urlencoded-1.2.2",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.form_urlencoded-1.2.2.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__getrandom-0.2.15",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.getrandom-0.2.15.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__getrandom-0.3.4",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.getrandom-0.3.4.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__hashbrown-0.12.3",
        sha256 = "8a9ee70c43aaf417c914396645a0fa852624801b24ebb7ae78fe8272889ac888",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/hashbrown/0.12.3/download"],
        strip_prefix = "hashbrown-0.12.3",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.hashbrown-0.12.3.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.hermit-abi-0.3.9.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__hmac-sha256-1.1.12",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.hmac-sha256-1.1.12.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__icu_collections-2.1.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.icu_collections-2.1.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__icu_locale_core-2.1.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.icu_locale_core-2.1.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__icu_normalizer-2.1.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.icu_normalizer-2.1.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__icu_normalizer_data-2.1.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.icu_normalizer_data-2.1.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__icu_properties-2.1.2",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.icu_properties-2.1.2.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__icu_properties_data-2.1.2",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.icu_properties_data-2.1.2.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__icu_provider-2.1.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.icu_provider-2.1.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.idna-1.1.0.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__idna_adapter-1.2.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.idna_adapter-1.2.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__indexmap-1.9.3",
        sha256 = "bd070e393353796e801d209ad339e89596eb4c8d430d18ede6a1cced8fafbd99",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/indexmap/1.9.3/download"],
        strip_prefix = "indexmap-1.9.3",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.indexmap-1.9.3.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__io-lifetimes-1.0.11",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.io-lifetimes-1.0.11.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__jiff-0.2.16",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.jiff-0.2.16.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__jiff-static-0.2.16",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.jiff-static-0.2.16.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__js-sys-0.3.83",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.js-sys-0.3.83.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__libc-0.2.178",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.libc-0.2.178.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.linux-raw-sys-0.11.0.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__linux-raw-sys-0.3.8",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.linux-raw-sys-0.3.8.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__litemap-0.8.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.litemap-0.8.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.log-0.4.29.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__memchr-2.7.6",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.memchr-2.7.6.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__miniz_oxide-0.8.9",
        sha256 = "1fa76a2c86f704bdb222d66965fb3d63269ce38518b83cb0575fca855ebb6316",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/miniz_oxide/0.8.9/download"],
        strip_prefix = "miniz_oxide-0.8.9",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.miniz_oxide-0.8.9.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__once_cell-1.21.3",
        sha256 = "42f5e15c9953c5e4ccceeb2e7382a716482c34515315f7b03532b8b4e8393d2d",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/once_cell/1.21.3/download"],
        strip_prefix = "once_cell-1.21.3",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.once_cell-1.21.3.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__os_str_bytes-6.6.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.os_str_bytes-6.6.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__percent-encoding-2.3.2",
        sha256 = "9b4f627cb1b25917193a259e49bdad08f671f8d9708acfd5fe0a8c1455d87220",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/percent-encoding/2.3.2/download"],
        strip_prefix = "percent-encoding-2.3.2",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.percent-encoding-2.3.2.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__portable-atomic-1.12.0",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.portable-atomic-1.12.0.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__portable-atomic-util-0.2.4",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.portable-atomic-util-0.2.4.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__potential_utf-0.1.4",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.potential_utf-0.1.4.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__proc-macro2-1.0.103",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.proc-macro2-1.0.103.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__quick-error-1.2.3",
        sha256 = "a1d01941d82fa2ab50be1e79e6714289dd7cde78eba4c074bc5a4374f650dfe0",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/quick-error/1.2.3/download"],
        strip_prefix = "quick-error-1.2.3",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.quick-error-1.2.3.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__quote-1.0.42",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.quote-1.0.42.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__r-efi-5.3.0",
        sha256 = "69cdb34c158ceb288df11e18b4bd39de994f6657d83847bdffdbd7f346754b0f",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/r-efi/5.3.0/download"],
        strip_prefix = "r-efi-5.3.0",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.r-efi-5.3.0.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__regex-1.12.2",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.regex-1.12.2.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__regex-automata-0.4.13",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.regex-automata-0.4.13.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__regex-syntax-0.8.8",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.regex-syntax-0.8.8.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__ring-0.17.14",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.ring-0.17.14.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__rustix-0.37.28",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.rustix-0.37.28.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__rustix-1.1.2",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.rustix-1.1.2.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__rustls-0.23.35",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.rustls-0.23.35.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__rustls-pki-types-1.13.2",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.rustls-pki-types-1.13.2.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__rustls-webpki-0.103.8",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.rustls-webpki-0.103.8.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__rustversion-1.0.22",
        sha256 = "b39cdef0fa800fc44525c84ccb54a029961a8215f9619753635a9c0d2538d46d",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/rustversion/1.0.22/download"],
        strip_prefix = "rustversion-1.0.22",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.rustversion-1.0.22.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__safemem-0.3.3",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.safemem-0.3.3.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__serde-1.0.228",
        sha256 = "9a8e94ea7f378bd32cbbd37198a4a91436180c5bb472411e48b5ec2e2124ae9e",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/serde/1.0.228/download"],
        strip_prefix = "serde-1.0.228",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.serde-1.0.228.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__serde_core-1.0.228",
        sha256 = "41d385c7d4ca58e59fc732af25c3983b67ac852c1a25000afe1175de458b67ad",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/serde_core/1.0.228/download"],
        strip_prefix = "serde_core-1.0.228",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.serde_core-1.0.228.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__serde_derive-1.0.228",
        sha256 = "d540f220d3187173da220f885ab66608367b6574e925011a9353e4badda91d79",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/serde_derive/1.0.228/download"],
        strip_prefix = "serde_derive-1.0.228",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.serde_derive-1.0.228.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__shlex-1.3.0",
        sha256 = "0fda2ff0d084019ba4d7c6f371c95d8fd75ce3524c3cb8fb653a3023f6323e64",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/shlex/1.3.0/download"],
        strip_prefix = "shlex-1.3.0",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.shlex-1.3.0.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__simd-adler32-0.3.8",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.simd-adler32-0.3.8.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__smallvec-1.15.1",
        sha256 = "67b1b7a3b5fe4f1376887184045fcf45c69e92af734b7aaddc05fb777b6fbd03",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/smallvec/1.15.1/download"],
        strip_prefix = "smallvec-1.15.1",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.smallvec-1.15.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__ssh-keys-0.1.4",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.ssh-keys-0.1.4.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__stable_deref_trait-1.2.1",
        sha256 = "6ce2be8dc25455e1f91df71bfa12ad37d7af1092ae736f3a6cd0e37bc7810596",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/stable_deref_trait/1.2.1/download"],
        strip_prefix = "stable_deref_trait-1.2.1",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.stable_deref_trait-1.2.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__subtle-2.6.1",
        sha256 = "13c2bddecc57b384dee18652358fb23172facb8a2c51ccc10d74c157bdea3292",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/subtle/2.6.1/download"],
        strip_prefix = "subtle-2.6.1",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.subtle-2.6.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__syn-2.0.111",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.syn-2.0.111.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__synstructure-0.13.2",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.synstructure-0.13.2.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__terminal_size-0.2.6",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.terminal_size-0.2.6.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__terminal_size-0.4.3",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.terminal_size-0.4.3.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__textwrap-0.16.2",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.textwrap-0.16.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.thiserror-2.0.17.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.thiserror-impl-2.0.17.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__tinystr-0.8.2",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.tinystr-0.8.2.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__unicode-ident-1.0.12",
        sha256 = "3354b9ac3fae1ff6755cb6db53683adb661634f67557942dea4facebec0fee4b",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/unicode-ident/1.0.12/download"],
        strip_prefix = "unicode-ident-1.0.12",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.unicode-ident-1.0.12.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__untrusted-0.9.0",
        sha256 = "8ecb6da28b8a351d773b68d5825ac39017e680750f980f3a1a85cd8dd28a47c1",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/untrusted/0.9.0/download"],
        strip_prefix = "untrusted-0.9.0",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.untrusted-0.9.0.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__ureq-2.12.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.ureq-2.12.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__uri_encode-1.0.4",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.uri_encode-1.0.4.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.url-2.5.7.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__utf8_iter-1.0.4",
        sha256 = "b6c140620e7ffbb22c2dee59cafe6084a59b5ffc27a8859a5f0d494b5d52b6be",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/utf8_iter/1.0.4/download"],
        strip_prefix = "utf8_iter-1.0.4",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.utf8_iter-1.0.4.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__wasi-0.11.0-wasi-snapshot-preview1",
        sha256 = "9c8d87e72b64a3b4db28d11ce29237c246188f4f51057d65a7eab63b7987e423",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/wasi/0.11.0+wasi-snapshot-preview1/download"],
        strip_prefix = "wasi-0.11.0+wasi-snapshot-preview1",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.wasi-0.11.0+wasi-snapshot-preview1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__wasip2-1.0.1-wasi-0.2.4",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.wasip2-1.0.1+wasi-0.2.4.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__wasm-bindgen-0.2.106",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.wasm-bindgen-0.2.106.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__wasm-bindgen-macro-0.2.106",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.wasm-bindgen-macro-0.2.106.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__wasm-bindgen-macro-support-0.2.106",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.wasm-bindgen-macro-support-0.2.106.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__wasm-bindgen-shared-0.2.106",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.wasm-bindgen-shared-0.2.106.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__wasmsign2-0.2.6",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.wasmsign2-0.2.6.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__wasmsign2-cli-0.2.6",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.wasmsign2-cli-0.2.6.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__webpki-roots-0.26.11",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.webpki-roots-0.26.11.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__webpki-roots-1.0.4",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.webpki-roots-1.0.4.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows-link-0.2.1",
        sha256 = "f0805222e57f7521d6a62e36fa9163bc891acd422f971defe97d64e70d0a4fe5",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/windows-link/0.2.1/download"],
        strip_prefix = "windows-link-0.2.1",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows-link-0.2.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows-sys-0.48.0",
        sha256 = "677d2418bec65e3338edb076e806bc1ec15693c5d0104683f2efe857f61056a9",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/windows-sys/0.48.0/download"],
        strip_prefix = "windows-sys-0.48.0",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows-sys-0.48.0.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows-sys-0.52.0",
        sha256 = "282be5f36a8ce781fad8c8ae18fa3f9beff57ec1b52cb3de0789201425d9a33d",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/windows-sys/0.52.0/download"],
        strip_prefix = "windows-sys-0.52.0",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows-sys-0.52.0.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows-sys-0.60.2",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows-sys-0.60.2.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows-sys-0.61.2",
        sha256 = "ae137229bcbd6cdf0f7b80a31df61766145077ddf49416a728b02cb3921ff3fc",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/windows-sys/0.61.2/download"],
        strip_prefix = "windows-sys-0.61.2",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows-sys-0.61.2.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows-targets-0.48.5",
        sha256 = "9a2fa6e2155d7247be68c096456083145c183cbbbc2764150dda45a87197940c",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/windows-targets/0.48.5/download"],
        strip_prefix = "windows-targets-0.48.5",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows-targets-0.48.5.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows-targets-0.52.6",
        sha256 = "9b724f72796e036ab90c1021d4780d4d3d648aca59e491e6b98e725b84e99973",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/windows-targets/0.52.6/download"],
        strip_prefix = "windows-targets-0.52.6",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows-targets-0.52.6.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows-targets-0.53.5",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows-targets-0.53.5.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_aarch64_gnullvm-0.48.5",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_aarch64_gnullvm-0.48.5.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_aarch64_gnullvm-0.52.6",
        sha256 = "32a4622180e7a0ec044bb555404c800bc9fd9ec262ec147edd5989ccd0c02cd3",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/windows_aarch64_gnullvm/0.52.6/download"],
        strip_prefix = "windows_aarch64_gnullvm-0.52.6",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_aarch64_gnullvm-0.52.6.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_aarch64_gnullvm-0.53.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_aarch64_gnullvm-0.53.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_aarch64_msvc-0.48.5",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_aarch64_msvc-0.48.5.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_aarch64_msvc-0.52.6",
        sha256 = "09ec2a7bb152e2252b53fa7803150007879548bc709c039df7627cabbd05d469",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/windows_aarch64_msvc/0.52.6/download"],
        strip_prefix = "windows_aarch64_msvc-0.52.6",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_aarch64_msvc-0.52.6.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_aarch64_msvc-0.53.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_aarch64_msvc-0.53.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_i686_gnu-0.48.5",
        sha256 = "a75915e7def60c94dcef72200b9a8e58e5091744960da64ec734a6c6e9b3743e",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/windows_i686_gnu/0.48.5/download"],
        strip_prefix = "windows_i686_gnu-0.48.5",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_i686_gnu-0.48.5.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_i686_gnu-0.52.6",
        sha256 = "8e9b5ad5ab802e97eb8e295ac6720e509ee4c243f69d781394014ebfe8bbfa0b",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/windows_i686_gnu/0.52.6/download"],
        strip_prefix = "windows_i686_gnu-0.52.6",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_i686_gnu-0.52.6.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_i686_gnu-0.53.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_i686_gnu-0.53.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_i686_gnullvm-0.52.6",
        sha256 = "0eee52d38c090b3caa76c563b86c3a4bd71ef1a819287c19d586d7334ae8ed66",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/windows_i686_gnullvm/0.52.6/download"],
        strip_prefix = "windows_i686_gnullvm-0.52.6",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_i686_gnullvm-0.52.6.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_i686_gnullvm-0.53.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_i686_gnullvm-0.53.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_i686_msvc-0.48.5",
        sha256 = "8f55c233f70c4b27f66c523580f78f1004e8b5a8b659e05a4eb49d4166cca406",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/windows_i686_msvc/0.48.5/download"],
        strip_prefix = "windows_i686_msvc-0.48.5",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_i686_msvc-0.48.5.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_i686_msvc-0.52.6",
        sha256 = "240948bc05c5e7c6dabba28bf89d89ffce3e303022809e73deaefe4f6ec56c66",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/windows_i686_msvc/0.52.6/download"],
        strip_prefix = "windows_i686_msvc-0.52.6",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_i686_msvc-0.52.6.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_i686_msvc-0.53.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_i686_msvc-0.53.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_x86_64_gnu-0.48.5",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_x86_64_gnu-0.48.5.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_x86_64_gnu-0.52.6",
        sha256 = "147a5c80aabfbf0c7d901cb5895d1de30ef2907eb21fbbab29ca94c5b08b1a78",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/windows_x86_64_gnu/0.52.6/download"],
        strip_prefix = "windows_x86_64_gnu-0.52.6",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_x86_64_gnu-0.52.6.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_x86_64_gnu-0.53.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_x86_64_gnu-0.53.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_x86_64_gnullvm-0.48.5",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_x86_64_gnullvm-0.48.5.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_x86_64_gnullvm-0.52.6",
        sha256 = "24d5b23dc417412679681396f2b49f3de8c1473deb516bd34410872eff51ed0d",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/windows_x86_64_gnullvm/0.52.6/download"],
        strip_prefix = "windows_x86_64_gnullvm-0.52.6",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_x86_64_gnullvm-0.52.6.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_x86_64_gnullvm-0.53.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_x86_64_gnullvm-0.53.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_x86_64_msvc-0.48.5",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_x86_64_msvc-0.48.5.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_x86_64_msvc-0.52.6",
        sha256 = "589f6da84c646204747d1270a2a5661ea66ed1cced2631d546fdfb155959f9ec",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/windows_x86_64_msvc/0.52.6/download"],
        strip_prefix = "windows_x86_64_msvc-0.52.6",
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_x86_64_msvc-0.52.6.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__windows_x86_64_msvc-0.53.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.windows_x86_64_msvc-0.53.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__wit-bindgen-0.46.0",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.wit-bindgen-0.46.0.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__writeable-0.6.2",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.writeable-0.6.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.yoke-0.8.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__yoke-derive-0.8.1",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.yoke-derive-0.8.1.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__zerofrom-0.1.6",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.zerofrom-0.1.6.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__zerofrom-derive-0.1.6",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.zerofrom-derive-0.1.6.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__zeroize-1.8.2",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.zeroize-1.8.2.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__zerotrie-0.2.3",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.zerotrie-0.2.3.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__zerovec-0.11.5",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.zerovec-0.11.5.bazel"),
    )

    maybe(
        http_archive,
        name = "ws__zerovec-derive-0.11.2",
        ...
        build_file = Label("//bazel/cargo/wasmsign/remote:BUILD.zerovec-derive-0.11.2.bazel"),
    )

    return [
        struct(repo = "ws__wasmsign2-cli-0.2.6", is_dev_dep = False),
    ]
