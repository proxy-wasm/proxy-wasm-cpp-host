...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "crates_vendor__ct-codecs-1.1.1",
    ...
    maybe(
        http_archive,
        name = "crates_vendor__ed25519-compact-1.0.16",
    ...
    maybe(
        http_archive,
        name = "crates_vendor__hmac-sha512-1.1.5",
    ...
    maybe(
        http_archive,
        name = "crates_vendor__unicode-width-0.1.13",
