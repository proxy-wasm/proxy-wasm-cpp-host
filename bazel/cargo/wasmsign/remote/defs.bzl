...
_NORMAL_DEPENDENCIES = {
    "bazel/cargo/wasmsign": {
        _COMMON_CONDITION: {
            "wasmsign": Label("@crates_vendor__wasmsign-0.1.2//:wasmsign"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "crates_vendor__anyhow-1.0.53",
        sha256 = "94a45b455c14666b85fc40a019e8ab9eb75e3a124e05494f5397122bc9eb06e0",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/anyhow/1.0.53/download"],
        strip_prefix = "anyhow-1.0.53",
        build_file = Label("@proxy_wasm_cpp_host//bazel/cargo/wasmsign/remote:BUILD.anyhow-1.0.53.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@proxy_wasm_cpp_host//bazel/cargo/wasmsign/remote:BUILD.byteorder-1.4.3.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor__ed25519-compact-1.0.8",
        sha256 = "302ea73924517e9952bf08b505536f757e28dca8372cbf8b20723a0e2bab6c01",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/ed25519-compact/1.0.8/download"],
        strip_prefix = "ed25519-compact-1.0.8",
        build_file = Label("@proxy_wasm_cpp_host//bazel/cargo/wasmsign/remote:BUILD.ed25519-compact-1.0.8.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor__getrandom-0.2.4",
        sha256 = "418d37c8b1d42553c93648be529cb70f920d3baf8ef469b74b9638df426e0b4c",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/getrandom/0.2.4/download"],
        strip_prefix = "getrandom-0.2.4",
        build_file = Label("@proxy_wasm_cpp_host//bazel/cargo/wasmsign/remote:BUILD.getrandom-0.2.4.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor__hmac-sha512-1.1.1",
        sha256 = "6b2ce076d8070f292037093a825343f6341fe0ce873268c2477e2f49abd57b10",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/hmac-sha512/1.1.1/download"],
        strip_prefix = "hmac-sha512-1.1.1",
        build_file = Label("@proxy_wasm_cpp_host//bazel/cargo/wasmsign/remote:BUILD.hmac-sha512-1.1.1.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor__libc-0.2.114",
        sha256 = "b0005d08a8f7b65fb8073cb697aa0b12b631ed251ce73d862ce50eeb52ce3b50",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/libc/0.2.114/download"],
        strip_prefix = "libc-0.2.114",
        build_file = Label("@proxy_wasm_cpp_host//bazel/cargo/wasmsign/remote:BUILD.libc-0.2.114.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor__parity-wasm-0.42.2",
    ...
    maybe(
        ...
        build_file = Label("@proxy_wasm_cpp_host//bazel/cargo/wasmsign/remote:BUILD.proc-macro2-1.0.36.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@proxy_wasm_cpp_host//bazel/cargo/wasmsign/remote:BUILD.quote-1.0.15.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@proxy_wasm_cpp_host//bazel/cargo/wasmsign/remote:BUILD.syn-1.0.86.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor__thiserror-1.0.30",
        sha256 = "854babe52e4df1653706b98fcfc05843010039b406875930a70e4d9644e5c417",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/thiserror/1.0.30/download"],
        strip_prefix = "thiserror-1.0.30",
        build_file = Label("@proxy_wasm_cpp_host//bazel/cargo/wasmsign/remote:BUILD.thiserror-1.0.30.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor__thiserror-impl-1.0.30",
        sha256 = "aa32fd3f627f367fe16f893e2597ae3c05020f8bba2666a4e6ea73d377e5714b",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/thiserror-impl/1.0.30/download"],
        strip_prefix = "thiserror-impl-1.0.30",
        build_file = Label("@proxy_wasm_cpp_host//bazel/cargo/wasmsign/remote:BUILD.thiserror-impl-1.0.30.bazel"),
    )
    ...
    maybe(
        ...
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/unicode-width/0.1.9/download"],
        strip_prefix = "unicode-width-0.1.9",
        build_file = Label("@proxy_wasm_cpp_host//bazel/cargo/wasmsign/remote:BUILD.unicode-width-0.1.9.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@proxy_wasm_cpp_host//bazel/cargo/wasmsign/remote:BUILD.unicode-xid-0.2.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@proxy_wasm_cpp_host//bazel/cargo/wasmsign/remote:BUILD.wasi-0.10.2+wasi-snapshot-preview1.bazel"),
    )

    maybe(
        new_git_repository,
        name = "crates_vendor__wasmsign-0.1.2",
    ...
    return [
        struct(repo = "crates_vendor__wasmsign-0.1.2", is_dev_dep = False),
    ]
