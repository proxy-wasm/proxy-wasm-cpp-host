...
# buildifier: disable=bzl-visibility
load("//bazel/cargo/wasmtime/remote:defs.bzl", _crate_repositories = "crate_repositories")
...
def crate_repositories():
    ...
    maybe(
        ...
        name = "cu",
        build_file = Label("//bazel/cargo/wasmtime/remote:BUILD.bazel"),
        defs_module = Label("//bazel/cargo/wasmtime/remote:defs.bzl"),
    )
